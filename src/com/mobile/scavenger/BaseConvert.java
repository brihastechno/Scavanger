...
public class BaseConvert {
	...
	public static void encode(java.nio.ByteBuffer raw,
		...
		while (raw.hasRemaining()) {
			...
			raw.get(raw3, 0, rem);
			BaseConvert.encode3to4(enc4, raw3, rem, BaseConvert.NO_OPTIONS);
			encoded.put(enc4);
		} // end input remaining
	}
	 ...
	 *            Specified options
	 * @return The Base64-encoded object
	 * @see BaseConvert#GZIP
	 * @see BaseConvert#DO_BREAK_LINES
	 * @throws java.io.IOException
	 *             if there is an error
	 * @since 2.0
	 */
	public static String encodeObject(java.io.Serializable serializableObject,
		...
		try {
			...
			b64os = new BaseConvert.OutputStream(baos, ENCODE | options);
			if ((options & GZIP) != 0) {
				// Gzip
	...
	public static byte[] encodeBytesToBytes(byte[] source, int off, int len,
		...
		if ((options & GZIP) != 0) {
			java.io.ByteArrayOutputStream baos = null;
			java.util.zip.GZIPOutputStream gzos = null;
			BaseConvert.OutputStream b64os = null;
	...
	public static byte[] decode(byte[] source) throws java.io.IOException {
		byte[] decoded = null;
		// try {
		decoded = decode(source, 0, source.length, BaseConvert.NO_OPTIONS);
		// } catch( java.io.IOException ex ) {
		// assert false :
	...
	public static void encodeToFile(byte[] dataToEncode, String filename)
		...
		BaseConvert.OutputStream bos = null;
		try {
			bos = new BaseConvert.OutputStream(new java.io.FileOutputStream(
					filename), BaseConvert.ENCODE);
	...
	public static byte[] decodeFromFile(String filename)
		...
		BaseConvert.InputStream bis = null;
		try {
			...
			// Open a stream
			bis = new BaseConvert.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), BaseConvert.DECODE);
	...
	public static String encodeFromFile(String filename)
		...
		try {
			...
			// Open a stream
			bis = new BaseConvert.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), BaseConvert.ENCODE);
			...
			encodedData = new String(buffer, 0, length,
					BaseConvert.PREFERRED_ENCODING);
	...
	public static void encodeFileToFile(String infile, String outfile)
		...
		String encoded = BaseConvert.encodeFromFile(infile);
	...
	public static void decodeFileToFile(String infile, String outfile)
		...
		byte[] decoded = BaseConvert.decodeFromFile(infile);
		java.io.OutputStream out = null;
		try {
			out = new java.io.BufferedOutputStream(
					new java.io.FileOutputStream(outfile));
	...
	/**
	 * A {@link BaseConvert.InputStream} will read data from another
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link BaseConvert.InputStream} in DECODE mode.
		 * 
		 * @param in
		...
		/**
		 * Constructs a {@link BaseConvert.InputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 * 
		 ...
		 * @param options
		 *            Specified options
		 * @see BaseConvert#ENCODE
		 * @see BaseConvert#DECODE
		 * @see BaseConvert#DO_BREAK_LINES
		 * @since 2.0
		 */
	...
	/**
	 * A {@link BaseConvert.OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link BaseConvert.OutputStream} in ENCODE mode.
		 * 
		 * @param out
		...
		/**
		 * Constructs a {@link BaseConvert.OutputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 * 
			...
			// Else, Decoding
				...
				if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					if (position >= bufferLength) { // Enough to output.
						...
						int len = BaseConvert.decode4to3(buffer, 0, b4, 0,
								options);
						out.write(b4, 0, len);
						position = 0;
					} // end if: enough to output
